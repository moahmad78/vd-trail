...
const categories = [
  ...
  "Biophilic Office Designs", "Gypsum False Ceiling Designs", "Conference Room Designs", "Multi-Specialty Hospital Layout", "School Science Lab Interior", "Smart Classroom Design", "Modular Kitchen Systems",
...
const Footer = () => {
 ...
 key={idx} 
 href={social.href} 
 className="w-9 h-9 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:text-[#0f172a] hover:border-[#0f172a] transition-all"
 title={social.name}
 >
 {social.icon}
 </a>
 ...
 <p className="text-xs font-normal text-slate-400 mb-0.5">Instant Connectivity</p>
 <p className="text-base font-normal text-[#0F172A]">Chat with us</p>
 </div>
 </a>
 </div>
 ...
 <div className="lg:border-l lg:border-slate-200 lg:pl-12">
 <div className="mb-4 lg:mb-10">
 <h5 className="text-card text-sm font-bold text-[#0F172A] mb-2">Our Expertise</h5>
 <div className="w-5 h-0.5 bg-[#0f172a]" />
 </div>
 <ul className="space-y-2 lg:space-y-4">
 {[
 ...
 <div className="lg:border-l lg:border-slate-200 lg:pl-12">
 <div className="mb-4 lg:mb-10">
 <h5 className="text-card text-sm font-bold text-[#0F172A] mb-2">Studio Address</h5>
 <div className="w-5 h-0.5 bg-[#0f172a]" />
 </div>
 ...
 <a href="https://wa.me/919845014279" className="text-neutral-500 hover:text-[#0F172A] transition-all text-base font-bold">
 +91 9845014279
 </a>
 </div>
 <div className="flex gap-4">
 <Mail size={24} className="text-[#0f172a] shrink-0" />
 <a href="mailto:shiraz@VoometDesign.com" className="text-neutral-500 hover:text-[#0F172A] transition-all text-base font-bold">
 ...
 {/* Section 1: Locations */}
 <div>
 <h6 className="text-card text-xs font-bold text-slate-400 mb-6">
 PAN-India Service Locations
 </h6>
 <div className="flex flex-wrap items-center gap-y-3">
 {locations.map((loc, idx) => (
 <React.Fragment key={idx}>
 <span className="text-xs text-slate-400 hover:text-[#0f172a] transition-colors cursor-default leading-relaxed">
 {loc}
 </span>
