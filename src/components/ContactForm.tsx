...
const ContactForm = () => {
 ...
 {/* Info Side */}
 <div className="lg:w-2/5 bg-[#0f172a] p-12 lg:p-20 text-white flex flex-col justify-between">
 <div>
 <h3 className="text-card text-4xl font-bold mb-8">Let's Discuss <br /> Your Project</h3>
 ...
 <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center text-[#0f172a]">
 <Phone size={24} />
 </div>
 <div>
 <p className="text-sm font-normal text-white/50">Call Us</p>
 <p className="font-normal">+91 9845014279</p>
 </div>
 </div>
 <div className="flex items-center gap-6">
 <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center text-[#0f172a]">
 ...
 <div>
 <p className="text-sm font-normal text-white/50">Studio</p>
 <p className="font-normal text-base">No. 166, Obandehalli Industrial Area, Doddaballapura, Bangalore, Karnataka.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <label className="text-base font-bold text-slate-400">Full Name</label>
 <input 
 type="text" 
 ...
 <div className="space-y-2">
 <label className="text-base font-bold text-slate-400">Email Address</label>
 <input 
 type="email" 
 ...
 <div className="space-y-2">
 <label className="text-base font-bold text-slate-400">Project Type</label>
 ...
 <div className="space-y-2">
 <label className="text-base font-bold text-slate-400">Estimated Area (Sq. Ft)</label>
 <input 
 type="number" 
 ...
 <label className="text-base font-bold text-slate-400">Message</label>
 <textarea 
 rows={4}
