...
const TestimonialMarquee = () => {
 return (
 <section className="py-6 md:py-12 bg-[#0f172a] relative overflow-hidden">
 <div className="absolute top-0 right-0 w-64 h-64 bg-[#0f172a]/5 rounded-full blur-3xl" />
 <div className="site-container md:px-6 mb-6 md:mb-12">
 <div className="border-l-4 border-slate-300 pl-4 md:pl-6">
 <h2 className="text-section text-[10px] md:text-xs mb-1 md:mb-2 block text-white">
 Social Proof
 </h2>
 <h3 className="text-card text-lg md:text-3xl text-white font-semibold tracking-[-0.03em] leading-tight">
 ...
 <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#0f172a]/20 flex items-center justify-center text-slate-400 font-bold text-sm md:text-base">
 {t.name[0]}
 </div>
 <div>
 <h4 className="text-card text-sm md:text-lg text-white">
 {t.name}
 </h4>
 <p className="text-[#324A61] text-[10px] md:text-xs block">
 {t.role}
 </p>
 </div>
 </div>
