      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-16">
          <div className="max-w-2xl">
            <h2 className="text-[10px] md:text-xs mb-2 md:mb-4 block font-black uppercase tracking-tight text-slate-950">
              Authority & Insights
            </h2>
            <h3 className="text-[#020617] text-xl md:text-3xl font-black uppercase tracking-wide text-slate-950">
              The VoometDesign Journal
            </h3>
          </div>
          <Link
            href="/blog"
            className="mt-4 md:mt-0 text-[10px] md:text-sm font-black uppercase tracking-widest text-[#020617] flex items-center gap-2 hover:text-[#324A61] transition-colors"
          >
            ...
            >
              <div className="h-48 md:h-64 relative overflow-hidden shrink-0">
                ...
                <div className="absolute top-4 left-4 md:top-6 md:left-6">
                  <span className="bg-[#020617] text-white md:text-primary text-[10px] md:text-xs font-bold px-2 md:px-3 py-1 rounded-full uppercase tracking-widest shadow-md">
                    {post.category}
                  </span>
                </div>
              </div>
              <div className="p-5 md:p-8 flex flex-col flex-grow">
                <p className="mb-2 md:mb-4 text-slate-600 leading-relaxed font-normal text-xs md:text-base">
                  {post.date}
                </p>
                <h4 className="mb-3 md:mb-4 text-[#020617] group-hover: transition-colors text-sm md:text-lg font-black uppercase tracking-wide text-slate-950">
                  {post.title}
                </h4>
                <p className="mb-4 md:mb-6 line-clamp-2 md:line-clamp-3 text-slate-600 leading-relaxed font-normal text-xs md:text-base flex-grow">
                  {post.excerpt}
                </p>
