...
export default function CareersPage() {
 ...
 >
 <div className="w-16 h-16 bg-slate-50 border border-slate-100 rounded-full flex items-center justify-center group-hover:bg-[#0f172a] group-hover:border-[#0f172a] text-[#0f172a] group-hover:text-white transition-colors duration-300">
 {item.icon}
 </div>
 <div>
 ...
 {/* Open Positions */}
 <section id="open-positions" className="py-24 bg-[#0f172a] text-white">
 <div className="site-container">
 ...
 <p className="font-normal text-body">voometd@gmail.com</p>
 </div>
 </div>
 <div className="bg-white/10 backdrop-blur-md border border-white/20 p-5 rounded-2xl flex items-center gap-4 hover:bg-white/20 transition-all cursor-default">
 <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
