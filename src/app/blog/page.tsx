      ...
      <div className="pt-32 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-[1440px] mx-auto px-4 py-12 items-start">
                  ...
                  <Link href={`/blog/${featuredPost.slug}`} className="block">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 bg-white border border-slate-100 rounded-2xl overflow-hidden mb-12 hover:shadow-md transition-all group">
                      ...
                      <div className="md:col-span-5 p-6 flex flex-col justify-center">
                        ...
                        <h2 className="line-clamp-3 mb-3 group-hover:text-[#324A61] transition-colors block text-2xl md:text-3xl font-black uppercase tracking-tight text-slate-950">
                          {" "}
                          {featuredPost.title}{" "}
                        </h2>
                        <p className="mb-4 line-clamp-3 text-slate-600 leading-relaxed font-normal text-base md:text-base">
                          {" "}
                          {featuredPost.snippet}{" "}
                        </p>
                        <span className="text-slate-500 text-sm font-semibold mt-2 block">
                          {" "}
                          {featuredPost.date} • By {featuredPost.author}{" "}
                        </span>
                        <span className="hover:text-[#324A61] mt-4 flex items-center gap-1.5 transition-colors md:text-sm font-black uppercase tracking-[0.25em] text-[#324A61] block mb-3">
                          {" "}
                      ...
                      >
                        <div className="bg-white border border-slate-100 rounded-xl overflow-hidden hover:shadow-md transition-all h-full flex flex-col">
                          ...
                          <div className="p-6 flex flex-col flex-grow">
                            ...
                            <h3 className="mb-3 group-hover:text-[#324A61] transition-colors block text-base md:text-base lg:text-lg font-black uppercase tracking-wide text-slate-950">
                              {" "}
                              {post.title}{" "}
                            </h3>
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {CATEGORIES.map((cat) => (
                  <button
                    ...
                    className={`px-4 py-3 border transition-all duration-200 ${activeCategory === cat ? "bg-[#324A61] text-white border-[#273a4d] font-bold text-sm uppercase tracking-wider rounded-xl" : "bg-slate-50 text-slate-500 border-slate-100 text-sm font-bold uppercase tracking-wider rounded-xl hover:bg-slate-100 hover:text-slate-900"}`}
                  >
                    {" "}
                    {cat}{" "}
                  </button>
            ...
            <div className="bg-white border border-slate-100 rounded-xl p-6 shadow-sm">
              ...
              <div className="flex flex-col space-y-4">
                <Link href="#" className="group">
                  <span className="text-slate-500 text-xs font-bold tracking-widest block mb-0.5">
                    01
                  </span>
                  <h5 className="group-hover:text-[#324A61] line-clamp-2 transition-colors block text-base md:text-base lg:text-lg font-black uppercase tracking-wide text-slate-950">
                    {" "}
            ...
            <div className="bg-[#020617] text-white p-6 rounded-xl border border-slate-800 mt-6 shadow-xl relative overflow-hidden">
              {" "}
              {/* Subtle background glow effect */}{" "}
              <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#020617]/10 rounded-full blur-2xl"></div>
              <div className="relative z-10">
                <span className="text-xs md:text-sm font-black uppercase tracking-[0.25em] text-[#324A61] block mb-3">
                  {" "}
                  VoometDesign BLUEPRINTS{" "}
                </span>
                <h4 className="mb-3 text-base md:text-base lg:text-lg font-black uppercase tracking-wide text-white">
                  {" "}
