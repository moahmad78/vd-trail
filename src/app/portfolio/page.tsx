...
const ALL_PROJECTS_DATA = [
  { id: '1', slug: 'apps-for-bharat', title: 'Apps for Bharat', location: 'Bangalore', category: 'CORPORATE', summary: 'End-to-end workplace transformation focused on collaboration and innovation.', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1200&q=80', heightClass: 'h-[340px] md:h-[360px]' }, // Featured
  ...
  { id: '6', slug: 'orbit', title: 'Orbit', location: 'Bangalore', category: 'HOSPITALITY', summary: 'A luxury dining and lounge experience setting new standards.', image: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=800&q=80', heightClass: 'h-[320px]' }, // Portrait
  { id: '7', slug: 'the-little-gym', title: 'The Little Gym', location: 'Bangalore', category: 'EDUCATIONAL', summary: 'Safe, dynamic, and colorful spaces for early childhood development.', image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=800&q=80', heightClass: 'h-[260px]' }, // Landscape
  ...
  { id: '9', slug: 'tech-hub', title: 'Tech Hub', location: 'Bangalore', category: 'CORPORATE', summary: 'A futuristic tech workspace.', image: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=800&q=80', heightClass: 'h-[260px]' }, // Landscape
  { id: '10', slug: 'villa-nova', title: 'Villa Nova', location: 'Bangalore', category: 'RESIDENTIAL', summary: 'Ultra-luxury bespoke villa interiors.', image: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=800&q=80', heightClass: 'h-[320px]' }, // Portrait
  { id: '11', slug: 'grand-hyatt', title: 'Grand Boutique', location: 'Bangalore', category: 'HOSPITALITY', summary: 'Immersive hospitality experience.', image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=800&q=80', heightClass: 'h-[280px]' }, // Square
