...
export default function PrivacyPage() {
  return (
    <main className="bg-white min-h-screen pt-24">
      {/* Hero */}
      <section className="bg-[#020617] text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-xs font-black uppercase tracking-[0.3em] text-[#324A61] block mb-4">
            LEGAL DOCUMENTATION
          </span>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
            <div className="flex flex-col items-center gap-2 p-4">
              ...
              <p className="text-xs font-black uppercase tracking-widest text-slate-700">We Never Sell Your Data</p>
            </div>
            <div className="flex flex-col items-center gap-2 p-4">
              <UserCheck size={24} className="text-[#324A61]" />
              <p className="text-xs font-black uppercase tracking-widest text-slate-700">You Control Your Information</p>
            </div>
            <div className="flex flex-col items-center gap-2 p-4">
              <Eye size={24} className="text-[#324A61]" />
              <p className="text-xs font-black uppercase tracking-widest text-slate-700">Full Transparency Always</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="max-w-4xl mx-auto px-4 py-20">
              ...
              >
                ...
                <div className="space-y-4 pl-14">
                  ...
                  {section.after?.map((para, j) => (
                    <p key={`after-${j}`} className="text-slate-600 leading-relaxed text-base font-medium border-l-4 border-[#324A61] pl-4 mt-4">
                      {para}
                    </p>
                  ))}
                </div>
        ...
        <div className="mt-16 bg-slate-50 border border-slate-200 rounded-3xl p-10 text-center">
          ...
          <h3 className="text-2xl font-black uppercase text-slate-900 mb-3">
            Privacy Questions or Data Requests?
          </h3>
          <p className="text-slate-600 leading-relaxed mb-6 max-w-lg mx-auto">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#020617] text-white font-black uppercase tracking-widest text-sm px-8 py-4 rounded-full hover:bg-[#324A61] transition-colors"
          >
            <Mail size={16} />
        ...
        <div className="mt-10 flex items-center justify-center gap-6 text-sm text-slate-400 font-bold uppercase tracking-widest">
          <Link href="/terms" className="hover:text-[#020617] transition-colors">
            Terms of Service
          </Link>
          <span className="text-slate-200">|</span>
          <Link href="/" className="hover:text-[#020617] transition-colors">
            Back to Home
          </Link>
        </div>
      </section>
