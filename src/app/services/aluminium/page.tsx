...
export default function AluminiumPage() {
  return (
    <main className="bg-white">
      {" "}
      <Navbar /> {/* Hero Section */}{" "}
      <section className="pt-48 pb-24 bg-[#f8fafc] text-slate-950 overflow-hidden relative border-b border-slate-100">
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <h2 className="mb-8 text-[#020617] text-2xl md:text-3xl font-black uppercase tracking-tight text-slate-950">
      ...
      <section className="py-24 bg-[#020617] text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <button className="bg-[#324A61] text-white text-sm font-black uppercase tracking-widest py-3.5 px-6 rounded-lg hover:bg-white hover:text-[#020617] transition-all duration-300 shadow-md">
            {" "}
